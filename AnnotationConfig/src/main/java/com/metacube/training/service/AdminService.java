...
public class AdminService {
    ...
    public Status addEmployee(Employee employee) {
        ...
        Employee employeeNew = employeeRepository.getEmployeeByEmail(employee.getEmail());
    ...
    public List<Employee> searchEmployees(String skill) {
        return employeeRepository.searchEmployeeBySkill(skill);
    }
    ...
    public Status deleteEmployeeByCode(int code) {
        ...
        if (employee != null) {
            employeeRepository.deleteEmployee("false", employee.getCode());
