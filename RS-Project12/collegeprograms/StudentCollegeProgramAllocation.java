...
class StudentProgram {
                ...
                while (cellIterator.hasNext()) {
                    ...
                    if("C:\\Users\\vishn_000\\Downloads\\Programs.xlsx".equals(fileName)) {
                        ...
                        case NUMERIC:
                            ...
                            DetailsOfProgramAllocation program = new DetailsOfProgramAllocation
    ...
    public void subjectAllocate(Student student, List<Object> programObjectList, String subject) {
        for(int i = 0; i < programObjectList.size(); i++) {
            if(subject.equals(((DetailsOfProgramAllocation)programObjectList.get(i)).getName()) && 
                ((DetailsOfProgramAllocation)programObjectList.get(i)).getCapacity()> = 1) {
    ...
    public void studentProgramAllocation() {
        ...
        for(int i = 0; i < studentObjectList.size(); i = i + 6) {
            ...
            Student student = new Student((String)studentObjectList.get(i), (String)studentObjectList.get(i + 1),
                (String)studentObjectList.get(i + 2), (String)studentObjectList.get(i + 3), (String)studentObjectList.get(i + 4),
                (String)studentObjectList.get(i + 5));
