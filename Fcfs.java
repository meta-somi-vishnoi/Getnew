...
class FcfsOperations {
	...
	*/
    ...
    /**
   	...
   	*/
    public int maxWaitingTime(int processTimings[][],int noOfProcess,int waiting[])
    {
    	int maximum=0;
    	for(int i=0;i<noOfProcess;i++) {
...
public class Fcfs {
    public static void main(String[] args) {
        ...
        FcfsOperations fcfsOperation=new FcfsOperations();
        ...
        int maximum= fcfsOperation.maxWaitingTime(processTimings,noOfProcess,waiting);
        System.out.println("The maximum waiting time is " + maximum);
    }
